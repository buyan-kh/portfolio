...
export const metadata: Metadata = {
  title: "Buyan's portfolio",
  description: "Buyan is an aspiring software engineer.",
};
  ...
  return (
    <html lang="en">
      <body
        ...
        bg-gray-50 text-gray-950 relative h-[4000px] pt-28 sm:pt-36`}
      >
        <div
        ...
        sm:w-[68.75] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"
        ></div>
        <Header />
        {children}
      </body>
